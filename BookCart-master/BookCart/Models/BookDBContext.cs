...
namespace BookCart.Models
{
    public partial class BookDBContext : DbContext
    {
        ...
        {
            // Configuration is now handled through DI in Startup/Program.cs
            if (!optionsBuilder.IsConfigured)
            {
                throw new InvalidOperationException("DbContext is not configured. Make sure it's registered in the service collection.");
            }
        }
